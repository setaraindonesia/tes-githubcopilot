...
const Dashboard: FC = () => {
  ...
  useEffect(() => {
    ...
    // Auto-login for development - always set to true
  ...
  useEffect(() => {
    ...
    if (isDropdownOpen || showChatMenu) {
        ...
        {activeBottomTab === 'home' && (
          <div>
                    ...
                    {chatList.map((chat) => (
                      <div
                        ...
                        onClick={() => {
                          setActiveChat(chat)
                          setChatMsgs([
                            { id: 1, text: 'Hai!', time: '10:31', from: 'them' },
                            { id: 2, text: 'Ada yang bisa saya bantu?', time: '10:31', from: 'them' },
                            { id: 3, text: 'Halo, mau tanya P2P ya', time: '10:32', from: 'me' },
                          ])
                        }}
                ...
                {activeChat && (
                  <div className="fixed inset-0 bg-white z-50 flex flex-col">
                    ...
                    <div className="flex items-center px-2 py-4 border-b border-gray-200 bg-white">
                      ...
                      <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center text-lg font-semibold mr-3 ml-1">
                        {activeChat.avatar}
                      </div>
                          ...
                          <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 z-50">
                            <div className="py-2">
                              ...
                              <button className="w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-50 flex items-center gap-3">
                                ...
                                <span className="text-sm">Cari Pesan</span>
                              </button>
                              <button className="w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-50 flex items-center gap-3">
                              ...
                              <button className="w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-50 flex items-center gap-3">
                                ...
                                <span className="text-sm">Pengaturan Chat</span>
                              </button>
                              <div className="h-px bg-gray-100 my-2" />
                              <button 
                                onClick={() => {
                        ...
                        {chatMsgs.map((m) => (
                          <div key={m.id} className={`flex ${m.from === 'me' ? 'justify-end' : 'justify-start'}`}>
                            <div className={`max-w-[80%] rounded-2xl px-4 py-2 ${
                              ...
                              <div className={`text-xs mt-1 ${m.from === 'me' ? 'text-indigo-100' : 'text-gray-400'}`}>
                                {m.time}
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="px-4 py-4 border-t border-gray-200 bg-white">
                      <form
                        onSubmit={(e) => {
                          e.preventDefault()
                          const form = e.currentTarget as HTMLFormElement & { msg: { value: string } }
                      ...
                      >
                        ...
                        <button 
                          type="submit" 
                          className="w-12 h-12 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 flex items-center justify-center"
                        >
            ...
            {isFabOpen && !activeChat && !showSeraChat && (
              <div className="fixed bottom-36 right-6 z-50 space-y-3">
                <button
            ...
            <div className="bg-white rounded-lg shadow-sm border">
              <div className="flex border-b border-gray-100">
                ...
                <button onClick={() => setWalletView('p2p')} className={`flex-1 py-3 text-center font-medium transition-colors ${walletView === 'p2p' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500'}`}>
                  <span className="inline-flex items-center gap-2"><Repeat2 className="w-4 h-4" /> P2P</span>
                </button>
